...
metoda displayPerson() wyświetla pola tego obiektu a metoda getLast() 
odczytuje nazwisko; jest to klucz wyszukiwania.
...
- pole klucza jest obiektem typu String a więc porównania wymagają metody equals() a nie operatora ==.  
